...
The tidy_data dataset differs from the original dataset in that it contains only the mean and standard deviation of variables, grouped by and averaged by the activity type and the subject.
